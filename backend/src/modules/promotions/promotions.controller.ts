...
export class PromotionsController {
  ...
  async getById(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return ResponseUtil.success(res, promotion, 'Promotion retrieved successfully');
    } catch (error: any) {
  ...
  async getByDealerId(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const promotions = await promotionsService.getByDealerId(dealerId, includeInactive);
      return ResponseUtil.success(res, promotions, 'Dealer promotions retrieved successfully');
    } catch (error: any) {
      return next(error);
    }
  }
  ...
  async getActivePromotions(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return ResponseUtil.success(res, promotions, 'Active promotions retrieved successfully');
    } catch (error: any) {
      return next(error);
    }
  }
  ...
  async create(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return ResponseUtil.created(res, promotion, 'Promotion created successfully');
    } catch (error: any) {
      if (
  ...
  async update(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return ResponseUtil.success(res, promotion, 'Promotion updated successfully');
    } catch (error: any) {
      if (error.message.includes('not found')) {
        return ResponseUtil.notFound(res, error.message);
      }
  ...
  async toggleStatus(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const promotion = await promotionsService.toggleStatus(id, userRole, dealerId);
      return ResponseUtil.success(
        res,
        promotion,
  ...
  async calculateDiscount(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      if (!dealerId || !purchaseAmount) {
        return ResponseUtil.badRequest(res, 'Dealer ID and purchase amount are required');
      }
      ...
      return ResponseUtil.success(res, result, 'Discount calculated successfully');
    } catch (error: any) {
      if (
